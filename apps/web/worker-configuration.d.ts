/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env staging` (hash: 6f6550540e3d6c81a177bc46c32e70b4)
// Runtime types generated with workerd@1.20250712.0 2025-04-04
declare namespace Cloudflare {
  interface Env {
    GOV_API: 'https://adm.tools/action/gov/api/';
    CLOUDFLARE_ENV: string;
    CLOUDFLARE_TOKEN: string;
    CLOUDFLARE_ACCOUNT_ID: string;
    WRANGLER_DATABASE_ID: string;
    WRANGLER_ROUTES_PATTERN: string;
    ASSETS: R2Bucket;
    POAS: R2Bucket;
    INVOICES: R2Bucket;
    BILLS: R2Bucket;
